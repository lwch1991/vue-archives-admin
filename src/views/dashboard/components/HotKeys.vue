<template>
  <div class="hot-key-container">
    <div class="tagBall">
      <a class="tag" href="#">档案</a>
      <a class="tag" href="#">漏洞扫描</a>
      <a class="tag" href="#">机器学习</a>
      <a class="tag" href="#">信息处理技术</a>
      <a class="tag" href="#">大数据时代</a>
      <a class="tag" href="#">保护技术</a>
      <a class="tag" href="#">审计</a>
    </div>
  </div>
</template>
    ...
    function innit() {
      for (var i = 0; i < tagEle.length; i++) {
        ...
        tagEle[i].style.color =
          ...
          parseInt(Math.random() * 255) +
          ')'
        // tagEle[i].style.background =
        //   'linear-gradient(0deg, ' + color16() + ', ' + color16() + ' 100%)'

        // tagEle[i].style.textFillColor = 'transparent'
